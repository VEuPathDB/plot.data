...
test_that("box.dt() accepts listVars for both the x axis and facet vars", {  
  ...
  map <- data.frame('id' = c('entity.y', 'entity.x', 'entity.z'), 'plotRef' = c('xAxisVariable', 'xAxisVariable', 'xAxisVariable'), 'dataType' = c('NUMBER', 'NUMBER', 'NUMBER'), 'dataShape' = c('CONTINUOUS', 'CONTINUOUS', 'CONTINUOUS'), stringsAsFactors=FALSE)
