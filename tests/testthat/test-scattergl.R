...
test_that("scattergl() returns appropriately formatted json", {
  ...
  expect_equal(names(jsonList$scatterplot$config),c('completeCasesAllVars','completeCasesAxesVars','variables'))
  expect_equal(names(jsonList$scatterplot$config$variables[[1]]@variableSpec),c('variableId','entityId'))
  expect_equal(jsonList$scatterplot$config$variables[[1]]@variableSpec@variableId, 'contA')
  ...
  expect_equal(names(jsonList$scatterplot$config),c('completeCasesAllVars','completeCasesAxesVars','variables'))
  expect_equal(names(jsonList$scatterplot$config$variables[[1]]@variableSpec),c('variableId','entityId'))
  expect_equal(veupathUtils::findVariableSpecFromPlotRef(jsonList$scatterplot$config$variables, 'overlay')@variableId, 'contC')
  ...
  expect_equal(names(jsonList$scatterplot$config$variables[[1]]@variableSpec),c('variableId','entityId'))
  expect_equal(jsonList$scatterplot$config$variables[[1]]@variableSpec@variableId, 'contA')
  expect_equal(jsonList$scatterplot$config$variables[[2]]@variableSpec@variableId, 'contB')
  expect_equal(names(jsonList$sampleSizeTable),c('overlayVariableDetails','facetVariableDetails','size'))
  expect_equal(class(jsonList$sampleSizeTable$facetVariableDetails[[1]]$value), 'character')
  expect_equal(class(jsonList$sampleSizeTable$overlayVariableDetails$value), 'character')
  ...
  expect_equal(names(jsonList$scatterplot$data$facetVariableDetails[[1]]),c('variableId','entityId','value'))
  expect_equal(names(jsonList$scatterplot$config),c('completeCasesAllVars','completeCasesAxesVars','computedVariableMetadata','variables'))
  expect_equal(jsonList$scatterplot$config$completeCasesAllVars, nrow(df))
  expect_equal(jsonList$scatterplot$config$completeCasesAxesVars, nrow(df))
  expect_equal(names(jsonList$sampleSizeTable),c('facetVariableDetails','size'))
  expect_equal(class(jsonList$sampleSizeTable$facetVariableDetails[[1]]$value), 'character')
...
test_that("scattergl.dt() returns correct information about missing data", {
  ...
  expect_equal(names(jsonList$scatterplot$config),c('completeCasesAllVars','completeCasesAxesVars','variables'))
  expect_equal(names(jsonList$scatterplot$config$variables[[1]]@variableSpec),c('variableId','entityId'))
  expect_equal(veupathUtils::findVariableSpecFromPlotRef(jsonList$scatterplot$config$variables, 'overlay'), 'contC')
  expect_equal(names(jsonList$sampleSizeTable),c('facetVariableDetails','size'))
  expect_equal(class(jsonList$sampleSizeTable$facetVariableDetails[[1]]$value), 'character')
  expect_equal(jsonList$sampleSizeTable$facetVariableDetails[[1]]$variableId, 'cat4')
  expect_equal(names(jsonList$completeCasesTable),c('variableDetails','completeCases'))
