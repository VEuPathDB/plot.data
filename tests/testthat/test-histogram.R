...
test_that("histogram.dt() returns requested numBins/ binWidth", {
  ...
  dt <- histogram.dt(df, map, binWidth = .3, value='count', binReportValue, viewport)
  ...
  dt <- histogram.dt(df, map, binWidth = 1.5, value='count', binReportValue, viewport)
  ...
  binWidth <- numBinsToBinWidth(df$var, 5)
   dt <- histogram.dt(df, map, binWidth = binWidth, value='count', binReportValue, viewport)
...
test_that("histogram.dt() returns a valid plot.data histogram object", {
  ...
  expect_equal(names(namedAttrList),c('xAxisVariable', 'completeCases','completeCasesTable','sampleSizeTable','facetVariable1', 'facetVariable2', 'summary', 'viewport', 'binSlider', 'binSpec'))
